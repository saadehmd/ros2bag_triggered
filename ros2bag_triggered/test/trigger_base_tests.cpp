...
void surge_tests(ros2bag_triggered::tests::EmptyTrigger& triggers, double persistance_duration, size_t no_of_surges, bool use_null_termination=false, bool should_trigger=false)
{
    triggers.reset();
...
TEST(AllTriggerTests, on_surge_test)
{
    ...
    surge_tests(triggers_unpersisted, /*trigger_duration=*/ 0, /*no_of_surges=*/10, /*use_null_termination=*/false, /*should_trigger=*/true);
    surge_tests(triggers_unpersisted, /*trigger_duration=*/ 0, /*no_of_surges=*/10, /*use_null_termination=*/ true, /*should_trigger=*/true); //Test abort surge
    ...
    {
        surge_tests(triggers_persisted, /*trigger_duration=*/ duration, /*no_of_surges=*/3, /*use_null_termination=*/false, /*should_trigger=*/duration == trigger_duration);
        surge_tests(triggers_persisted, /*trigger_duration=*/ duration, /*no_of_surges=*/3, /*use_null_termination=*/true, /*should_trigger=*/duration == trigger_duration); //Test abort surge
...
TEST(AllTriggerTests, test_enabled)
{
    ...
    surge_tests(triggers, /*trigger_duration=*/ 0.1, /*no_of_surges=*/3, /*use_null_termination=*/false, /*should_trigger=*/false);
    triggers.set_enabled(true);
    surge_tests(triggers, /*trigger_duration=*/ 0.1, /*no_of_surges=*/3, /*use_null_termination=*/false, /*should_trigger=*/true);
}
