...
using MyVariant = std::variant<
  std::monostate, examples::ZoneTriggerWithPoseStamped, examples::ZoneTriggerWithNavSatFix,
  examples::NavSatInvalidFixTrigger, examples::BatteryHealthTrigger,
  examples::PoseCovarianceTrigger, examples::VelocityTrigger, examples::JointEffortTrigger>;

int main(int argc, char ** argv)
{
  rclcpp::init(argc, argv);
  auto node = std::make_shared<ros2bag_triggered::TriggeredRecorderNode<MyVariant>>(
    "triggered_recorder_node", rclcpp::NodeOptions(),
