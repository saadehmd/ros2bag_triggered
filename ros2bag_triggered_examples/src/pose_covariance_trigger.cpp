...
bool PoseCovarianceTrigger::isTriggered(const nav_msgs::msg::Odometry::SharedPtr msg) const
{
...
void PoseCovarianceTrigger::configureConditionalParams(const YAML::Node& node)
{
